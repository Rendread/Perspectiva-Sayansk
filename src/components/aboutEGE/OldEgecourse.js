<div className="EGEFormEducation">
  <div className="EGEFormEducationContainer">
    ...
    <div className="EGEFormEducationTextContainerEllipse">
      <div className="EGEFormEducationEllipse"></div>
      <p1 className="egeformeducationtextcontainerellipseP1">
        персональные консультации для каждого слушателя с разработкой необходимых рекомендаций;
      </p1>
    </div>
    <div className="EGEFormEducationTextContainerEllipse">
      <div className="EGEFormEducationEllipse"></div>
    ...
    <p className="EGEFormEducationText">
      Подготовка к ЕГЭ с 10-го класса позволяет не просто поэтапно и основательно подготовиться к
      ЕГЭ, но и создать прочную базу для дальнейшего обучения.
    </p>
    <p className="EGEFormEducationText">Основные цели подготовительных курсов для 10-го класса:</p>
    <div className="EGEFormEducationTextContainerEllipse">
      <div className="EGEFormEducationEllipse"></div>
      <p1 className="egeformeducationtextcontainerellipseP1">
    ...
    <p className="EGEFormEducationText">
      Для перехода в 10 класс или поступления в учреждение среднего профессионального образования
      необходимы положительные отметки по ОГЭ. Наш центр предлагает своим ученикам курсы подготовки
      к ОГЭ в 9 классе по всем предметам, что открывает возможности для дальнейшего продолжения
      образования.
    </p>
    <div className="EGEFormEducationPreTextDivFirst">
      <div>
    ...
    <p className="EGEFormEducationText">
      В рамках подготовки ЕГЭ мы работаем на максимально положительный результат. Каждый слушатель
      тестируется для определения уровня знаний и для него составляются персональные рекомендации.
    </p>
    <p className="EGEFormEducationText">
      Курсы подготовки к ЕГЭ в 11 классе – это залог успешной сдачи ЕГЭ и поступления на бюджет в
      ВУЗ Вашей мечты!
    </p>
  </div>
</div>;
